...
//kskim
LIB_API void* network_predict_using_gradient_hook(network* net, image im);
LIB_API void* get_network_info(network* net);
LIB_API void* get_network_layers(network* net);
LIB_API void network_forward_image(network* net, image im);
LIB_API void network_backward(network* net);
LIB_API void network_zero_delta(network* net);
